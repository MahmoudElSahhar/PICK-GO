...
public class RecyclerViewAdapter  extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.productName.setText(currentProduct.getProduct().getName());
        holder.price.setText("Price: " + currentProduct.getUnitPrice() + " EGP");
        holder.quantity.setText("Quantity: " + currentProduct.getQuantity());
        holder.productImage.setBackgroundResource(R.drawable.logo4);
        Picasso.get().load(currentProduct.getProduct().getImagePath()).into(holder.productImage);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            ...
            removeItem = itemView.findViewById(R.id.btn_productrecord_removeitem);
