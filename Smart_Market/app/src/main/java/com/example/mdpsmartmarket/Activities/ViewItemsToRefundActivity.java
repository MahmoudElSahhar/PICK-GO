            ...
            public void onClick(View v) {
                for(int i = 0; i < refundedCart.getItems().size(); i++) {
                    ...
                    //Product product = (Product) Product.view(cart.getItems().get(i).getProductID());
                     cart.getItems().get(i).getProduct().setQuantity(cart.getItems().get(i).getProduct().getQuantity() + refundedCart.getItems().get(i).getQuantity());
                    Product.update(cart.getItems().get(i).getProduct());
